...
/** vga_entry:
 *  Returns a 16 bit value which represents a foreground and background color and a value to write
 *
 ...
 *  Writes a null terminated string to the framebuffer and moves to the next line
 *
 *  @param data a pointer to the start of the string to write
 */
